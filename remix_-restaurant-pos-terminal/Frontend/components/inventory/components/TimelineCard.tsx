import { ShoppingCart, Utensils, SlidersHorizontal, Trash2, ClipboardCheck } from 'lucide-react';
...
export default function TimelineCard({ entry, isLast }: { entry: TimelineEntry; isLast?: boolean }) {
