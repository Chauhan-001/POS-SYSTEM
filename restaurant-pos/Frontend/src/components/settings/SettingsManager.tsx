...
import type { SystemSettings, VisitMilestone, RolePermissions, ModuleSettings, Bill, Order, KOTRecord } from '../../types';
import ThermalReceipt from '../billing/ThermalReceipt';
import { computeTaxSummary } from '../../lib/taxSummary';
import ThermalKOT from '../orders/ThermalKOT';
import { printKOT } from '../../utils/printKOT';
import { MODULE_FEATURE_MAP } from '../../hooks/usePOSState';
...
import { useServerSettings, getDeviceId, type ServerSettingsApi } from '../../hooks/useServerSettings';
...
const DEFAULT_MODULES: ModuleSettings = {
  ...
  // closing assistant, plus the inventory intelligence cards whose engine was
  // never committed after the AI layer was removed).
};
