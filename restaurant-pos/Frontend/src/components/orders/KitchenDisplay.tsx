...
import type { Order, KOTRecord, KOTStatus } from '../../types';
import { getKOTElapsedMinutes, kotPrintedTimeMs } from '../../utils/kotTime';
import { setKotAlertEnabled } from '../../lib/alertSound';
