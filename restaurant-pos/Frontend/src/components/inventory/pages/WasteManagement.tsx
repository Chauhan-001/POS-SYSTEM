...
// PHASE 3: the AI waste analysis card (aiData live fetch, then the
// deterministic analyzeWasteLocal engine) was removed with the AI layer —
// the engine file was never committed. The log + form below remain.
...
export default function WasteManagement({ moduleSettings }: { moduleSettings?: Record<string, boolean> }) {
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
      ...
      {/* Waste Analysis card removed (Phase 3) — its deterministic engine was
           never committed (see the 'removed ai' commit) and the analysis
           numbers could no longer be produced. */}
